...
class HistMatch(object):
    """Convert ndarrays in sample to Tensors."""
    def __init__(self):
        self.val_avg_img1_hist = self.get_all_image_hist("/nas_data/litianhan/S2Looking_cut/val/Image1")
        self.val_avg_img2_hist = self.get_all_image_hist("/nas_data/litianhan/S2Looking_cut/val/Image2")
